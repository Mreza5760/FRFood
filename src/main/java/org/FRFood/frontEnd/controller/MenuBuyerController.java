...
public class MenuBuyerController {
    @FXML
    ...
    public static void setData(int inMenuId, String inMenuTitle, int inRestaurantId) {
        menuId = inMenuId;
        menuTitle = inMenuTitle;
        restaurantId = inRestaurantId;
    }
